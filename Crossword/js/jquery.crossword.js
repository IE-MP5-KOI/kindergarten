...
(function($){
	$.fn.crossword = function(entryData) {
      ...
      puzz.data = JSON.parse(JSON.stringify(entryData));
      // puzz.data = entryData;
      // puzz.data = JSON.parse(JSON.stringify(entryData));
			
			// append clues markup after puzzle wrapper div
			// This should be moved into a configuration object
			this.after('<div id="puzzle-clues" class="puzzle-clues"><h2>Across</h2><ol id="across"></ol><h2>Down</h2><ol id="down"></ol></div>');
			
			// initialize some variables
			var tbl = ['<table id="puzzle" class="puzzle">'],
			    puzzEl = this,
				clues = $('#puzzle-clues'),
				clueLiEls,
				coords,
        ...
        // console.log(entryCount,entries,puzz.data);
